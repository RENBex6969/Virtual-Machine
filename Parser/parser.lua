...
local G = { V"Lua",
  ...
  Stat        = V"IfStat" + V"DoStat" + V"WhileStat" + V"RepeatStat" + V"ForStat"
            ...
            + V"FuncCall" + V"Assignment" + V"SemicolonStat" + -V"BlockEnd" * throw("InvalidStat");
              
  BlockEnd    = P"return" + "end" + "elseif" + "else" + "until" + -1;
  
  SemicolonStat = tagC("Semicolon", sym(";"));
  ...
  RetStat    = tagC("Return", kw("return") * commaSep(V"Expr", "RetList")^-1 * V"SemicolonStat"^-1);
